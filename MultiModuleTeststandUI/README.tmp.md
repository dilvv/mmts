...
pip3 install   flask   flask-socketio   requests   sphinx   paramiko   pyvisa   pyvisa-py   pyyaml   flask-wtf   myst-parser   flask-cors   pymeasure==0.14.0   python-snap7==2.0.2   psycopg psycopg2-binary
sudo apt update
